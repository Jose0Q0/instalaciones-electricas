"""
config.py — Tablas de datos normativos para instalaciones eléctricas de baja tensión.

Contiene: calibres AWG, áreas de conductores aislados (Tabla 4.7 NOM),
áreas internas de tuberías Conduit PVC (Tablas 4.5/4.6 NOM),
ampacidades (NEC 310.16), resistividades y propiedades de cables.

Diseño modular: agregar calibres, tuberías o tipos de cable solo requiere
añadir entradas a los diccionarios existentes.
"""

from __future__ import annotations

# ══════════════════════════════════════════════════════════════════
# 1. Calibres AWG — Área del conductor desnudo (mm²)
# ══════════════════════════════════════════════════════════════════
...
# Orden para selección de calibre mínimo (de menor a mayor sección)
...
# ══════════════════════════════════════════════════════════════════
# 2. Áreas de conductores con aislamiento (mm²) — Tabla 4.7 NOM
#    Necesarias para cálculo de factor de relleno en tuberías.
# ══════════════════════════════════════════════════════════════════

INSULATION_GROUPS: list[str] = ["THW/TW", "THHN"]

INSULATED_AREA_MM2: dict[str, dict[str, float]] = {
    # Grupo THW/TW: incluye TW, THW, THW-LS, THHW, THHW-LS, RHW
    "THW/TW": {
    ...
    # Grupo THHN: incluye THHN, THWN, XHHW (aislamiento más delgado)
    "THHN": {
...
# ══════════════════════════════════════════════════════════════════
# 3. Tubería Conduit PVC Schedule 40 — Área interna (mm²)
#    Tablas 4.5 / 4.6 NOM-001-SEDE
# ══════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════
# 4. Factores de relleno normativos (NOM-001-SEDE / NEC 362)
# ══════════════════════════════════════════════════════════════════

FILL_FACTORS: dict[str, float] = {
    "1":  0.55,   # 1 conductor:  55 %
    "2":  0.30,   # 2 conductores: 30 %
    "3+": 0.40,   # 3 o más:       40 %
}
...
# ══════════════════════════════════════════════════════════════════
# 5. Resistividad de materiales (Ω·mm²/m)
# ══════════════════════════════════════════════════════════════════

RESISTIVITY: dict[str, float] = {
    "Cobre":    0.0175,   # ρ = 0.0175 Ω·mm²/m  (a 20 °C)
    "Aluminio": 0.0282,   # ρ = 0.0282 Ω·mm²/m  (a 20 °C)
}


# ══════════════════════════════════════════════════════════════════
# 6. Ampacidad — Conductores de cobre (NEC 310.16 / Tabla 310-16)
#    Valores en Amperes según temperatura del aislamiento.
# ══════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════
# 7. Límites de caída de tensión (NOM-001-SEDE)
# ══════════════════════════════════════════════════════════════════

VOLTAGE_DROP_LIMITS: dict[str, float] = {
    "derivado": 0.03,   # 3 % máximo en circuitos derivados
    "total":    0.05,   # 5 % máximo alimentador + derivado
}


# ══════════════════════════════════════════════════════════════════
# 8. Tipos de cable y propiedades de aislamiento
# ══════════════════════════════════════════════════════════════════
